...
//  2026-03-11: Vulkan: Added
//  ImGui_ImplVulkan_PipelineInfo::ExtraDynamicStates[] to allow specifying
//  extra dynamic states to add when creating the VkPipeline. (#9211)
