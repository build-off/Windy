...
//  2026-03-25: Mouse cursor is properly restored if changed by user app/code
//  while using glfwSetInputMode(..., GLFW_CURSOR_DISABLED) or
//  ImGuiConfigFlags_NoMouseCursorChange. Amend change from 2025-12-10.
//  2026-02-10: Try to set IMGUI_IMPL_GLFW_DISABLE_X11 /
//  IMGUI_IMPL_GLFW_DISABLE_WAYLAND automatically if corresponding headers are
//  not accessible. (#9225) 2025-12-12: Added IMGUI_IMPL_GLFW_DISABLE_X11 /
...
static void ImGui_ImplGlfw_UpdateMouseCursor() {
  ...
  if ((io.ConfigFlags & ImGuiConfigFlags_NoMouseCursorChange) ||
    ...
    bd->LastMouseCursor =
        nullptr; // Invalidate so that if user changes underlying cursor we will
                 // update it next time we can.
    return;
  }
