...
struct ImGui_ImplVulkan_PipelineInfo {
  ...
  ImVector<VkDynamicState>
      ExtraDynamicStates; // Optional, allows to insert more dynamic states into
                          // our VkPipeline
...
struct ImGui_ImplVulkanH_Window {
  ...
  ImGui_ImplVulkanH_Window() {
    ...
    AttachmentDesc.format =
        VK_FORMAT_UNDEFINED; // Will automatically use wd->SurfaceFormat.format.
